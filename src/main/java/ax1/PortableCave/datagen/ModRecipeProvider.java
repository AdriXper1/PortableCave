...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(RecipeOutput recipeOutput) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItem.STONE_DRILL.get(), 1)
                .pattern("DD ")
                .pattern("DI ")
                .pattern("  I")
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItem.STONE_EXTRACTOR_ITEM.get(), 1)
                ...
                .unlockedBy("has_stone_drill", has(ModItem.STONE_DRILL))
                .save(recipeOutput);

        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItem.IRON_EXTRACTOR_ITEM.get(), 1)
                .pattern("SIS")
                .pattern("IDI")
                .pattern("SIS")
                .define('D', ModItem.IRON_DRILL)
                .define('I', Items.IRON_INGOT)
                .define('S', Items.STONE)
                .unlockedBy("has_iron_drill", has(ModItem.IRON_DRILL))
                .save(recipeOutput);

        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItem.DIAMOND_EXTRACTOR_ITEM.get(), 1)
                .pattern("SIS")
                .pattern("IDI")
                .pattern("SIS")
                .define('D', ModItem.DIAMOND_DRILL)
                .define('I', Items.IRON_INGOT)
                .define('S', Items.STONE)
                .unlockedBy("has_diamond_drill", has(ModItem.DIAMOND_DRILL))
                .save(recipeOutput);

        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItem.NETHERITE_EXTRACTOR_ITEM.get(), 1)
                .pattern("SIS")
                .pattern("IDI")
                .pattern("SIS")
                .define('D', ModItem.NETHERITE_DRILL)
                .define('I', Items.IRON_INGOT)
                .define('S', Items.STONE)
                .unlockedBy("has_netherite_drill", has(ModItem.NETHERITE_DRILL))
                .save(recipeOutput);

        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItem.ULTIMATE_EXTRACTOR_ITEM.get(), 1)
                .pattern("SIS")
                .pattern("IDI")
                .pattern("SIS")
                ...
                .define('I', Items.IRON_INGOT)
                .define('S', Items.STONE)
                .unlockedBy("has_ultimate_drill", has(ModItem.ULTIMATE_DRILL))
                .save(recipeOutput);
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModBlock.POWER_GENERATOR.get(), 1)
                .pattern("SRS")
                .pattern("RFR")
                .pattern("SRS")
                .define('S', Items.STONE)

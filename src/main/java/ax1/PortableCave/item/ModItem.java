...
public class ModItem {
    ...
    public static final DeferredItem<BlockItem> ORE_EXTRACTOR_LV1_ITEM = ITEMS.registerSimpleBlockItem("iron_ore_extractor", ModBlock.ORE_EXTRACTOR_LV1);
    public static final DeferredItem<BlockItem> ORE_EXTRACTOR_LV2_ITEM = ITEMS.registerSimpleBlockItem("diamond_ore_extractor", ModBlock.ORE_EXTRACTOR_LV2);
    public static final DeferredItem<BlockItem> ORE_EXTRACTOR_LV3_ITEM = ITEMS.registerSimpleBlockItem("netherite_ore_extractor", ModBlock.ORE_EXTRACTOR_LV3);
    public static final DeferredItem<BlockItem> ORE_EXTRACTOR_LV4_ITEM = ITEMS.registerSimpleBlockItem("ultimate_ore_extractor", ModBlock.ORE_EXTRACTOR_LV4);
